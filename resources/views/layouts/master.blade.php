...
<head>
  ...
  <!-- Template CSS -->
  <link rel="stylesheet" href=" {{ asset('../dahsboard/css/style.css') }}">
  <link rel="stylesheet" href="{{ asset('../dahsboard/css/components.css') }}">
...
<body>
  ...
  <script src="{{ asset('../dahsboard/js/stisla.js') }}"></script>
  ...
  <script src="{{ asset('../dahsboard/js/popper.min.js') }}"></script>

  <!-- JS Libraies -->
  @stack('page-scripts')

  <!-- Template JS File -->
  <script src="{{ asset('../dahsboard/js/scripts.js') }}"></script>
  <script src="{{ asset('../dahsboard/js/custom.js') }}"></script>
